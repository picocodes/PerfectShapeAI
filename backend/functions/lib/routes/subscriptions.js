...
subscriptionsRouter.post("/verify-mobile", requireAuth, async (req, res) => {
...
subscriptionsRouter.post("/verify-freemius", requireAuth, async (req, res) => {
...
subscriptionsRouter.post("/activate-premium", requireAuth, async (req, res) => {
